        ...
        <CardContent className="pt-6 pb-6 sm:pt-8 sm:pb-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base px-5 sm:px-6 py-2 sm:py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
            >
